# -*- coding: utf-8 -*-
"""
Created on Thu Dec 27 23:50:01 2018
...
class Table:
    ...
    def __init__(self,window,colour = "black", net_colour="green", width=600, height=400, vertical_net=False, horizontal_net = False):
        ...
        if(horizontal_net):
            self.canvas.create_line(0, self.height/2, self.width, self.height/2, self.height/2, width=2, fill=net_colour, dash=(15,23))
    ...
    def change_item_colour(self, item, c):
        self.canvas.itemconfigure(self, item, c)
